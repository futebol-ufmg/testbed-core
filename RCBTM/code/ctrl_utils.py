...
POOL_PATH = '/home/futebol/cbtm-pool/'
...
def copy_image(target, new_name, host):
    ...
    try:
        ...
        print 'Could not find connection for the intended rack:',host.get_name()
        raise
    ...
    vol_XML = vol_XML \
        ...
        .replace('${POOL_PATH}',POOL_PATH) # path for the images in the racks
